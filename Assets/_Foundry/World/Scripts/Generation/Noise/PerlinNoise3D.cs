...
/// <summary>
/// True 3D gradient noise based on Ken Perlin's improved reference implementation.
/// Replaces the 6-sample 2D approximation which caused origin symmetry / quad mirroring
/// on cube-sphere meshes.
/// </summary>
public static class PerlinNoise3D
{
    ...
    public static float GenerateNoise(float x, float y, float z)
    {
        ...
        // Remap from [-1, 1] to [0, 1] to match the existing pipeline
